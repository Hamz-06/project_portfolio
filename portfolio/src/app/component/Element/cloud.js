...
function Cloud({ leftSide }) {
    ...
    return (
        <animated.div onClick={() => setClicked(true)} className={`inline-block cloud z-[20] tall:top-6 fixed cloud`} style={{ left: dimensions.xAxis + '%', top: dimensions.yAxis + '%', ...fadeCloudIn, ...bounceCloud }}>
